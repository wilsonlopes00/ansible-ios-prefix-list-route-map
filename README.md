...
Prefix-lists and route-maps are the main tools of network operators to control the route advertisements in the core and edge network infrastructure, used by dynamic routing protocols like bgp.
<br>
